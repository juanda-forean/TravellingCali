...
@Composable
fun HomeScreen(actividadRepo: ActividadRepository) {
    ...
    fun coincideBarrio(actividad: Actividad, filtro: String): Boolean {
        ...
        // Coincidencia "suave": exacto o que contenga el nombre
        return zona == filtroNormalizado || zona.contains(filtroNormalizado)
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Travelling Cali") }
            )
        }
    ) { paddingValues ->
